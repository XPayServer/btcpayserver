            ...
            try
            {
                ...
                if (criteria != null)
                {
                    ...
                    if (currentRateToCrypto?.BidAsk != null)
                    {
                        ...
                        {
                            logs.Write($"{logPrefix} invoice amount below accepted value for payment method");
                            return null;
                        }
                        if (amount > limitValueCrypto && !criteria.Above)
                        {
                            logs.Write($"{logPrefix} invoice amount above accepted value for payment method");
                            return null;
                        }
                    }
                }
